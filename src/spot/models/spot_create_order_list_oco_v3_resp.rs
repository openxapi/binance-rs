...
pub struct SpotCreateOrderListOcoV3Resp {
    ...
    pub order_reports: Option<Vec<models::SpotCreateOrderListOcoV3RespOrderReportsInner>>,
...
impl SpotCreateOrderListOcoV3Resp {
    pub fn new() -> SpotCreateOrderListOcoV3Resp {
