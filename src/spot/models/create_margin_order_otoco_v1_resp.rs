...
pub struct CreateMarginOrderOtocoV1Resp {
    ...
    pub order_reports: Option<Vec<models::CreateMarginOrderOtoV1RespOrderReportsInner>>,
...
impl CreateMarginOrderOtocoV1Resp {
    pub fn new() -> CreateMarginOrderOtocoV1Resp {
