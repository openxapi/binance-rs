...
pub struct SpotDeleteOrderListV3Resp {
    ...
    pub order_reports: Option<Vec<models::SpotDeleteOrderListV3RespOrderReportsInner>>,
...
impl SpotDeleteOrderListV3Resp {
    pub fn new() -> SpotDeleteOrderListV3Resp {
