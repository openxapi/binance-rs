...
pub struct CreateOrderOcoV3Resp {
    ...
    pub order_reports: Option<Vec<models::CreateOrderOcoV3RespOrderReportsInner>>,
...
impl CreateOrderOcoV3Resp {
    pub fn new() -> CreateOrderOcoV3Resp {
