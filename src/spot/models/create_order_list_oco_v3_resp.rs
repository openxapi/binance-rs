...
pub struct CreateOrderListOcoV3Resp {
    ...
    pub order_reports: Option<Vec<models::CreateOrderListOcoV3RespOrderReportsInner>>,
...
impl CreateOrderListOcoV3Resp {
    pub fn new() -> CreateOrderListOcoV3Resp {
