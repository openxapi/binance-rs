...
pub struct SpotCreateSorOrderV3Resp {
    ...
    pub fills: Option<Vec<models::SpotCreateSorOrderV3RespFillsInner>>,
...
impl SpotCreateSorOrderV3Resp {
    pub fn new() -> SpotCreateSorOrderV3Resp {
