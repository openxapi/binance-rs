...
pub struct CreateOrderListOtocoV3Resp {
    ...
    pub order_reports: Option<Vec<models::CreateOrderListOtoV3RespOrderReportsInner>>,
...
impl CreateOrderListOtocoV3Resp {
    pub fn new() -> CreateOrderListOtocoV3Resp {
