...
pub struct DeleteOrderListV3Resp {
    ...
    pub order_reports: Option<Vec<models::DeleteOrderListV3RespOrderReportsInner>>,
...
impl DeleteOrderListV3Resp {
    pub fn new() -> DeleteOrderListV3Resp {
