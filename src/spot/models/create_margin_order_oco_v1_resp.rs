...
pub struct CreateMarginOrderOcoV1Resp {
    ...
    pub order_reports: Option<Vec<models::CreateMarginOrderOcoV1RespOrderReportsInner>>,
...
impl CreateMarginOrderOcoV1Resp {
    pub fn new() -> CreateMarginOrderOcoV1Resp {
