...
pub struct SpotCreateOrderOcoV3Resp {
    ...
    pub order_reports: Option<Vec<models::SpotCreateOrderOcoV3RespOrderReportsInner>>,
...
impl SpotCreateOrderOcoV3Resp {
    pub fn new() -> SpotCreateOrderOcoV3Resp {
