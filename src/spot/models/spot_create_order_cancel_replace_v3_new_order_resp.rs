...
pub struct SpotCreateOrderCancelReplaceV3NewOrderResp {
    ...
    pub fills: Option<Vec<models::SpotCreateOrderCancelReplaceV3NewOrderRespFillsInner>>,
...
impl SpotCreateOrderCancelReplaceV3NewOrderResp {
    pub fn new() -> SpotCreateOrderCancelReplaceV3NewOrderResp {
