...
pub struct GetSubAccountMarginAccountSummaryV1Resp {
    #[serde(rename = "subAccountList", skip_serializing_if = "Option::is_none")]
    pub sub_account_list: Option<Vec<models::GetSubAccountMarginAccountSummaryV1RespSubAccountListInner>>,
...
impl GetSubAccountMarginAccountSummaryV1Resp {
    pub fn new() -> GetSubAccountMarginAccountSummaryV1Resp {
