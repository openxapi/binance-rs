...
pub struct MarginGetMarginAccountV1Resp {
    ...
    pub user_assets: Option<Vec<models::MarginGetMarginAccountV1RespUserAssetsInner>>,
}

impl MarginGetMarginAccountV1Resp {
    pub fn new() -> MarginGetMarginAccountV1Resp {
