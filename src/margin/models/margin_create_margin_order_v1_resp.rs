...
pub struct MarginCreateMarginOrderV1Resp {
    ...
    pub fills: Option<Vec<models::MarginCreateMarginOrderV1RespFillsInner>>,
...
impl MarginCreateMarginOrderV1Resp {
    pub fn new() -> MarginCreateMarginOrderV1Resp {
