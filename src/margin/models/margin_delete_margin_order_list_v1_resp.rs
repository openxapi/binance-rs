...
pub struct MarginDeleteMarginOrderListV1Resp {
    ...
    pub order_reports: Option<Vec<models::MarginDeleteMarginOrderListV1RespOrderReportsInner>>,
...
impl MarginDeleteMarginOrderListV1Resp {
    pub fn new() -> MarginDeleteMarginOrderListV1Resp {
