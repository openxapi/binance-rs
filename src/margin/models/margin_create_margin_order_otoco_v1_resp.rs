...
pub struct MarginCreateMarginOrderOtocoV1Resp {
    ...
    pub order_reports: Option<Vec<models::MarginCreateMarginOrderOtoV1RespOrderReportsInner>>,
...
impl MarginCreateMarginOrderOtocoV1Resp {
    pub fn new() -> MarginCreateMarginOrderOtocoV1Resp {
