...
pub struct MarginCreateMarginOrderOcoV1Resp {
    ...
    pub order_reports: Option<Vec<models::MarginCreateMarginOrderOcoV1RespOrderReportsInner>>,
...
impl MarginCreateMarginOrderOcoV1Resp {
    pub fn new() -> MarginCreateMarginOrderOcoV1Resp {
