...
pub struct GetAccountV2Resp {
    #[serde(rename = "assets", skip_serializing_if = "Option::is_none")]
    pub assets: Option<Vec<models::GetAccountV2RespAssetsInner>>,
    ...
    pub positions: Option<Vec<models::GetAccountV2RespPositionsInner>>,
...
impl GetAccountV2Resp {
    pub fn new() -> GetAccountV2Resp {
        GetAccountV2Resp {
            assets: None,
