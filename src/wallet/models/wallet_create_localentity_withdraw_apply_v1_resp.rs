...
pub struct WalletCreateLocalentityWithdrawApplyV1Resp {
...
impl WalletCreateLocalentityWithdrawApplyV1Resp {
    pub fn new() -> WalletCreateLocalentityWithdrawApplyV1Resp {
