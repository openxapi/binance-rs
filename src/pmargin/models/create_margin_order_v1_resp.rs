...
pub struct CreateMarginOrderV1Resp {
    ...
    pub fills: Option<Vec<models::CreateMarginOrderV1RespFillsInner>>,
...
impl CreateMarginOrderV1Resp {
    pub fn new() -> CreateMarginOrderV1Resp {
