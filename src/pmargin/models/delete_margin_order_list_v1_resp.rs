...
pub struct DeleteMarginOrderListV1Resp {
    ...
    pub order_reports: Option<Vec<models::DeleteMarginOrderListV1RespOrderReportsInner>>,
...
impl DeleteMarginOrderListV1Resp {
    pub fn new() -> DeleteMarginOrderListV1Resp {
