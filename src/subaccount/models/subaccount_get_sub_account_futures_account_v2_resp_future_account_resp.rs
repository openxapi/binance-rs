...
pub struct SubaccountGetSubAccountFuturesAccountV2RespFutureAccountResp {
    #[serde(rename = "assets", skip_serializing_if = "Option::is_none")]
    pub assets: Option<Vec<models::SubaccountGetSubAccountFuturesAccountV1RespAssetsInner>>,
...
impl SubaccountGetSubAccountFuturesAccountV2RespFutureAccountResp {
    pub fn new() -> SubaccountGetSubAccountFuturesAccountV2RespFutureAccountResp {
