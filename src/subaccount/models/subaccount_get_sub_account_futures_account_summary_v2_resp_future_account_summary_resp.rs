...
pub struct SubaccountGetSubAccountFuturesAccountSummaryV2RespFutureAccountSummaryResp {
    #[serde(rename = "asset", skip_serializing_if = "Option::is_none")]
    pub asset: Option<String>,
    #[serde(rename = "subAccountList", skip_serializing_if = "Option::is_none")]
    pub sub_account_list: Option<Vec<models::SubaccountGetSubAccountFuturesAccountSummaryV1RespSubAccountListInner>>,
...
impl SubaccountGetSubAccountFuturesAccountSummaryV2RespFutureAccountSummaryResp {
    pub fn new() -> SubaccountGetSubAccountFuturesAccountSummaryV2RespFutureAccountSummaryResp {
