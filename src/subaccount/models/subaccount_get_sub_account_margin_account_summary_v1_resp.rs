...
pub struct SubaccountGetSubAccountMarginAccountSummaryV1Resp {
    #[serde(rename = "subAccountList", skip_serializing_if = "Option::is_none")]
    pub sub_account_list: Option<Vec<models::SubaccountGetSubAccountMarginAccountSummaryV1RespSubAccountListInner>>,
...
impl SubaccountGetSubAccountMarginAccountSummaryV1Resp {
    pub fn new() -> SubaccountGetSubAccountMarginAccountSummaryV1Resp {
