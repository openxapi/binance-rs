...
pub struct SubaccountGetSubAccountMarginAccountV1Resp {
    ...
    pub margin_trade_coeff_vo: Option<Box<models::SubaccountGetSubAccountMarginAccountV1RespMarginTradeCoeffVo>>,
    #[serde(rename = "marginUserAssetVoList", skip_serializing_if = "Option::is_none")]
    pub margin_user_asset_vo_list: Option<Vec<models::SubaccountGetManagedSubaccountMarginAssetV1RespUserAssetsInner>>,
...
impl SubaccountGetSubAccountMarginAccountV1Resp {
    pub fn new() -> SubaccountGetSubAccountMarginAccountV1Resp {
