...
pub struct PmarginDeleteMarginOrderListV1Resp {
    ...
    pub order_reports: Option<Vec<models::PmarginDeleteMarginOrderListV1RespOrderReportsInner>>,
...
impl PmarginDeleteMarginOrderListV1Resp {
    pub fn new() -> PmarginDeleteMarginOrderListV1Resp {
