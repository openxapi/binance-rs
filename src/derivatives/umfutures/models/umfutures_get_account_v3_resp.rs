...
pub struct UmfuturesGetAccountV3Resp {
    #[serde(rename = "assets", skip_serializing_if = "Option::is_none")]
    pub assets: Option<Vec<models::UmfuturesGetAccountV3RespAssetsInner>>,
    ...
    pub positions: Option<Vec<models::UmfuturesGetAccountV3RespPositionsInner>>,
...
impl UmfuturesGetAccountV3Resp {
    pub fn new() -> UmfuturesGetAccountV3Resp {
