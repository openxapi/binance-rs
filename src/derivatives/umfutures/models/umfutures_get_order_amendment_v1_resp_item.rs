...
pub struct UmfuturesGetOrderAmendmentV1RespItem {
    #[serde(rename = "amendment", skip_serializing_if = "Option::is_none")]
    pub amendment: Option<Box<models::UmfuturesGetOrderAmendmentV1RespItemAmendment>>,
...
impl UmfuturesGetOrderAmendmentV1RespItem {
    pub fn new() -> UmfuturesGetOrderAmendmentV1RespItem {
