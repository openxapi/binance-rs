...
pub struct PmarginproGetPortfolioBalanceV1RespItem {
    ...
    #[serde(rename = "optionWalletBalance", skip_serializing_if = "Option::is_none")]
...
impl PmarginproGetPortfolioBalanceV1RespItem {
    pub fn new() -> PmarginproGetPortfolioBalanceV1RespItem {
