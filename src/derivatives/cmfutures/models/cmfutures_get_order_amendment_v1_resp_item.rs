...
pub struct CmfuturesGetOrderAmendmentV1RespItem {
    #[serde(rename = "amendment", skip_serializing_if = "Option::is_none")]
    pub amendment: Option<Box<models::CmfuturesGetOrderAmendmentV1RespItemAmendment>>,
...
impl CmfuturesGetOrderAmendmentV1RespItem {
    pub fn new() -> CmfuturesGetOrderAmendmentV1RespItem {
