...
pub struct CmfuturesGetAccountV1Resp {
    #[serde(rename = "assets", skip_serializing_if = "Option::is_none")]
    pub assets: Option<Vec<models::CmfuturesGetAccountV1RespAssetsInner>>,
    ...
    pub positions: Option<Vec<models::CmfuturesGetAccountV1RespPositionsInner>>,
    #[serde(rename = "updateTime", skip_serializing_if = "Option::is_none")]
    pub update_time: Option<i64>,
}

impl CmfuturesGetAccountV1Resp {
    pub fn new() -> CmfuturesGetAccountV1Resp {
